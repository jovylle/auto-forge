...
Return ONLY JSON: {"title":"...","category":"...","description":"...","features":["..."],"tags":["..."]}`;
    ...
    const pool = [
      ...
      { title: "Tide Choir", category: "generative", description: "A harbor that sings the tide in voices.", features: ["voice waves","tide choir","harbor mix"], tags:["choir","harbor","audio"] },
      { title: "Rust Atlas", category: "viz", description: "Log slow decay as a beautiful oxidation map.", features: ["rust log","patina viz","decay export"], tags:["rust","diary","canvas"] },
      { title: "Moth Radio", category: "social", description: "Trade night signals with fellow moths.", features: ["night dial","signal trade","swarm board"], tags:["moth","radio","night"] },
      { title: "Cinder Ledger", category: "tool", description: "Keep ash-gray accounts of burnt budgets.", features: ["ash log","burn rate","ember totals"], tags:["ash","ledger","tool"] },
      { title: "Fog Market", category: "game", description: "Trade goods you can barely see.", features: ["mist stalls","blind trade","fog horn"], tags:["fog","market","game"] },
      { title: "Dune Switch", category: "game", description: "Flip desert relays before the storm hits.", features: ["relay grid","storm timer","caravan score"], tags:["dune","relays","game"] },
      { title: "Inkwell Observatory", category: "viz", description: "Chart star notes from an ink-dark hill.", features: ["star chart","night notes","constellation link"], tags:["stars","notes","canvas"] },
      { title: "Copper Kite", category: "generative", description: "Fly a kite that telegraphs the wind.", features: ["wind sim","kite canvas","gust code"], tags:["kite","wind","telegraph"] },
    ];
